<template>
	<view class="uni-date">
			...
			<slot>
				<view class="uni-date-editor--x"
					...
					<view v-if="!isRange" class="uni-date-x uni-date-single">
						...
						<uni-icons v-if="showForward" class="icons" type="forward" color="#191919" size="18" style="font-weight: bold;"></uni-icons>
					</view>
		...
		<view v-if="!isPhone" v-show="pickerVisible" ref="datePicker" class="uni-date-picker__container">
			<view v-if="!isRange" class="uni-date-single--x" :style="pickerPositionStyle">
				...
				<view v-if="hasTime" class="uni-date-changed popup-x-header">
					...
					<time-picker type="time" v-model="pickerTime" :border="false" :disabled="!inputDate" @showTopLevelEle="showTopLevelEle"
		...
		<Calendar v-if="isPhone" ref="mobile" :clearDate="false" :date="calendarDate" :defTime="mobileCalendarTime"
			...
			:hideSecond="hideSecond" @confirm="mobileChange" @maskClose="close" @showTopLevelEle="showTopLevelEle"/>
	</view>
</template>
<script>
	/**
