  ...
  <view class="container_mini">
    <view class="whiteBg container_mini_header">
			...
			<view class="marginTop44">
			  <HeadTitle title="梦工场园区管理系统" imageSrc="../../static/asset/矩形.png" actionTitle="指派" @action="goDistributeTask"></HeadTitle>
			</view>
    ...
    <Tabbar :pagePath="'/pages/user/taskCenter/index'"></Tabbar>
  </view>
</template>
