    ...
    <u-popup :show="show" @close="cancel">
      ...
      <view style="padding: 20rpx;">
        ...
        <scroll-view :scroll-top="scrollTop" scroll-y="true" class="scroll-Y" @scrolltolower="$emit('lower')">
          ...
          <!--多选-->
          <u-checkbox-group v-if="type == 'checkbox'" :borderBottom="true" placement="column" iconPlacement="right"
            @change="checkboxChange" v-model="checkboxValue">
            <u-checkbox :customStyle="{marginBottom: '12px',paddingBottom:'12px'}" v-for="(item, index) in dataLists"
